...
" graphical file folder suggestion, use :e
...
"
"
" set tabstop=4                  " number of visual spaces per TAB ,when file is
" loaded in normal mode
" set softtabstop=4              " number of spaces in tab when editing in
" insert mode
